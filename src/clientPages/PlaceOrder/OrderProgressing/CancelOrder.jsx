...
export default function CancelOrder({ onSelect }) {
            ...
            <Modal show={showModal} onHide={() => setShowModal(false)} centered>
                <Modal.Body className="text-center">
                    <div className="p-4">
                        ...
                        {/* Description */}
                        <p className="mb-4">
                        If you would like to cancel your order, please note that cancellations are possible at least 24 hours before the agreed date. If you cancel later, a staggered
cancellation fee will apply: For orders under 100 euros: flat rate 20 euros. For orders over 100 euros: 20 percent of the order value, but a maximum of 100 euros. The fee will be paid via the chosen payment method
                        </p>
