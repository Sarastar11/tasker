...
export default function SummaryPending({ worker, serviceFee = 4.8 }) {
    ...
    // };
    const handleConfirm = () => {
        navigate("/client/complete", { state: { amount: total, worker: worker  } });
    };
    return (
        <>
            {/* Header */}
            ...
            <div className="p-3 mt-3 d-flex flex-column gap-3 fs-4">
                ...
                <div className='d-flex justify-content-end gap-3 mt-3 mb-5 align-items-center'>
                    ...
                    <Button
                        ...
                        onClick={() => navigate("/client/singleChat", { state: { worker: worker } })}
                        style={{
                            height: "69px",
                            width: "221px",
